...
column_names = {"Jan2018_Apr2018": ["NEC","Operating Revenue", "Operating Expense", "Adjusted Operating Earnings", "Gross Ticket Revenue", "Ridership (in Thousands)", "Seat Miles (in Millions)", "Passenger Miles (in Millions)", "eCSI", "Average Load Factor", "OTP"],
                ...
                "Mar2020_Jun2023": ["NEC", "Operating Revenue", "Operating Expense", "Adjusted Operating Earnings", "Ridership (in Thousands)", "Seat Miles (in Millions)", "Passenger Miles (in Millions)", "Average Load Factor", "OTP"],
...
column_coordinates = {"Jan2018_Apr2018": [140, 175, 210, 265, 302, 343, 380, 423, 443, 478],
                      "May2018_Sep2019": [206, 239, 277, 331, 375, 398, 430],
                      "Aug2018": [294, 345, 396, 478, 540, 574, 623],
                      "Oct2019_Feb2020": [239, 288, 339, 420, 480, 535, 598, 630, 679],
                      "Mar2020_Jun2023": [255, 305, 359, 442, 504, 561, 625, 670],
...
table_area = {"Jan2018_Apr2018": [118, 40, 573, 500],
              "May2018_Sep2019": [118, 101, 564, 454],
              "Aug2018": [115, 139, 767, 657],
...
def get_coordinates_for_month(monyr):
    ...
    elif monyr in ["May-2018", "June-2018", "July-2018", "September-2018", "October-2018", "November-2018", "December-2018", "January-2019", "February-2019", "March-2019", "April-2019"]:
        return column_coordinates["May2018_Sep2019"]
    elif monyr in ["August-2018"]:
        return column_coordinates["Aug2018"]
    elif monyr in ["May-2019", "June-2019", "July-2019", "August-2019", "September-2019", "October-2019", "November-2019", "December-2019", "January-2020", "February-2020"]:
...
def get_area_for_month(monyr):
    if monyr in ["January-2018", "February-2018", "March-2018", "April-2018"]:
        ...
        return table_area["May2018_Sep2019"]
    elif monyr in ["August-2018"]:
        return table_area["Aug2018"]
    elif monyr in ["May-2019", "June-2019", "July-2019", "August-2019", "September-2019", "October-2019", "November-2019", "December-2019", "January-2020", "February-2020"]:
...
def extract_data(pdf,coordinates,tabarea):
    total_pages = len(tabula.read_pdf(pdf, pages='all')) - 2 
...
def process_monthly_report(year, monyr):
    ...
    dfs = extract_data(pdf, coordinates, tabarea)
    dfs[0].columns = colnames
    dfs[0].to_csv('{}_RLR'.format(monyr))
