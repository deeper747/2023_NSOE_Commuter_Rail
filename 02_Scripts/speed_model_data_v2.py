...
model_east_spreadsheet.to_csv('../01_Data/02_Processed/randomForest/Speed_Model_East_v4.csv', index=False)
model_west_spreadsheet.to_csv('../01_Data/02_Processed/randomForest/Speed_Model_West_v4.csv', index=False)
model_r.to_csv('../01_Data/02_Processed/randomForest/Speed_Model_R_v4.csv', index=False)