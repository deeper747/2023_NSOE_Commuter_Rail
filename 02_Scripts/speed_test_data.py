...
gdf_test['Elev_Delta_CUR_ft'] = -(gdf_test['Elevation_Smoothen_ft'].diff(periods=-2).shift(1))
gdf_test[['Elevation_Smoothen_ft','Elev_Delta_CUR_ft']]
gdf_test.at[0, 'Elev_Delta_CUR_ft'] = gdf_test.at[1,'Elevation_Smoothen_ft'] - gdf_test.at[0,'Elevation_Smoothen_ft']
gdf_test.at[14339, 'Elev_Delta_CUR_ft'] = gdf_test.at[14339,'Elevation_Smoothen_ft'] - gdf_test.at[14338,'Elevation_Smoothen_ft']
...
## Identify the change in elevation from the preceding observation to the following observation. 
## Using observations spaced 50 feet apart, this corresponds to the change in elevation over a 100-feet run.
gdf_test_wb['Elev_Delta_CUR_ft'] = -(gdf_test_wb['Elevation_Smoothen_ft'].diff(periods=-2).shift(1))
gdf_test_wb[['Elevation_Smoothen_ft','Elev_Delta_CUR_ft']]

gdf_test_wb.at[0, 'Elev_Delta_CUR_ft'] = gdf_test_wb.at[1,'Elevation_Smoothen_ft'] - gdf_test_wb.at[0,'Elevation_Smoothen_ft']
gdf_test_wb.at[14339, 'Elev_Delta_CUR_ft'] = gdf_test_wb.at[14339,'Elevation_Smoothen_ft'] - gdf_test_wb.at[14338,'Elevation_Smoothen_ft']
...
clms_train = ['Carolinian','Crescent','Piedmont']
for i in clms_train:
    gdf_test[i]="0"
    gdf_test_wb[i]="0"
...
gdf_test_150 = gdf_test[6726:11952]
gdf_test_exact = gdf_test[6876:11802]

gdf_test_wb_150 = gdf_test_wb[(gdf_test_wb['Node_ID'] >= 6727) & (gdf_test_wb['Node_ID'] <= 11953)]
gdf_test_wb_exact = gdf_test_wb[(gdf_test_wb['Node_ID'] >= 6877) & (gdf_test_wb['Node_ID'] <= 11803)]
...
## for the stations as start and end
gdf_test_east_exact_r = gdf_test_exact[r_clms]
gdf_test_west_exact_r = gdf_test_exact[r_clms]
